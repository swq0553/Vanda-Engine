...
public:
	...
	inline CVoid CScene::SetShadowMap( const CChar * path )
	{
		//should be updated
		if( g_selectedName != -1 )
		{
			...
			{
				if( m_geometries[i]->m_nameIndex == g_selectedName )
					m_geometries[i]->SetShadowMap( path );
			}
		}
	}
	...
	inline CVoid CScene::SetAlphaMap( const CChar * path )
	{
		//should be updated
		if( g_selectedName != -1 )
		{
			...
			{
				if( m_geometries[i]->m_nameIndex == g_selectedName )
					m_geometries[i]->SetAlphaMap( path );
			}
		}
	}
	...
	inline CVoid CScene::RemoveShadowMap()
	{
		...
		if( g_selectedName != -1 )
		{
			...
			{
				if( m_geometries[i]->m_nameIndex == g_selectedName )
					m_geometries[i]->RemoveShadowMap();
			}
		}
	}
