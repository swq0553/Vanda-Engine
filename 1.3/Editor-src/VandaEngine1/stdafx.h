...
extern CBool g_translateObject; //we are in translation mode if an arrow is selected
extern CInt g_translateDirection; //X, Y, or Z
...
CVoid PrintInfo( CString strText, COLORREF color = COLOR_GREEN, CBool reset = CFalse ); // global print
CVoid PrintInfo2( CString strText, COLORREF color = COLOR_WHITE ); // global print
CVoid PrintInfo3( CString strText ); // global print
